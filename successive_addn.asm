...
***************OUTPUT***********************************        
saurabh@saurabh-VirtualBox:~$ nasm -f elf64 success.asm
saurabh@saurabh-VirtualBox:~$ ld -s -o l success.o
saurabh@saurabh-VirtualBox:~$ ./l

Program to Multiply two nos. using successive addition !
Exitrform Addition

Enter the 2-Digit Multiplicand (HexaDecimal No.) : 12

Enter the 2-Digit Multiplier (HexaDecimal No.) : 9

The Multiplication of the 2 nos. is :74
